...
public class ForeverHomeApplication extends Application  {
    ...
    public static ForeverHomeApplication get(Context context) {
        return (ForeverHomeApplication) context.getApplicationContext();
    }
